"""Test 2x2 solver on specific problem cases."""
import cv2
import numpy as np
from pathlib import Path
from solvers.solver_2x2 import solve_2x2

TEST_IDS = [8, 33, 42, 44, 46, 98]
...
if __name__ == "__main__":
    print("Testing 2x2 solver on problem cases\n")
    
    correct_count = 0
    for img_id in TEST_IDS:
        puzzle_path = f'./Gravity Falls/puzzle_2x2/{img_id}.jpg'
        ...
        print(f"{status} Image {img_id}: arrangement={arrangement}, score={score:.2f}")
